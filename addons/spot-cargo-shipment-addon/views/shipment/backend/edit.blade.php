                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Shipment[receiver_phone]" class="form-control"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Shipment[receiver_address]" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control kt-select2" id="select-how"
                                            ...
                                            @forelse (\App\BusinessSetting::where("
                                                key","payment_gateway")->where("value","1")->get() as $gateway)
                                        ...
                                        @foreach (\App\PackageShipment::where('shipment_id', $shipment->id)->get() as $pack)
                                            <div data-repeater-item class="row align-items-center"
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input id="kt_touchspin_qty" type="text" name="qty" class="form-control"
                                                        value="{{ $pack->qty }}" />
                                                    <div class="mb-2 d-md-none"></div>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input class="dimensions_r" type="text" class="form-control"
                                                        placeholder="{{ translate('Width') }}" value="{{ $pack->width }}"
                                                        name="width" />
