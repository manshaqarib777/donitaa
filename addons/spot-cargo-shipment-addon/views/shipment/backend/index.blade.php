                                ...
                                <div class="my-2 col-md-4 my-md-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <select name="client_id" class="form-control" id="kt_datatable_search_status">
                                            ...
                                            @foreach(\App\Client::withoutGlobalScope('restriction')->all() as $client)
                    ...
                    <tr>
                        <td>
                            @if($shipment->mission_id)
                                -
                            @else
                                <label class="checkbox checkbox-success"><input data-missionid="{{$shipment->mission_id}}" data-clientaddresssender="{{$shipment->client_address}}" data-clientaddress="{{$shipment->receiver_address}}" data-clientname="{{$shipment->receiver->name}}" data-clientstatehidden="{{$shipment->to_state_id}}" data-clientstate="{{$shipment->to_state->name ?? '' }}" data-clientareahidden="{{$shipment->to_area_id}}" data-clientarea="{{$shipment->to_area->name ?? '' }}" data-clientid="{{$shipment->client->id}}" data-branchid="{{$shipment->branch_id}}" data-branchname="{{$shipment->branch->name}}"  type="checkbox" class="sh-check checkbox-client-id-{{$shipment->client_id}}" name="checked_ids[]" value="{{$shipment->id}}" /><span></span></label>
                            @endif
                        </td>
