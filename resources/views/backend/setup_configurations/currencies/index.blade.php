...
<div class="mb-3 text-left aiz-titlebar">
	<div class="row align-items-center">
		<div class="col-md-6">
			<h1 class="h3">{{translate('All Currencies')}}</h1>
		</div>
		<div class="col-md-6 text-md-right">
			<a onclick="currency_modal()" class="btn btn-circle btn-primary">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="checkbox">
                                <input type="checkbox" onchange="update_currency_status(this)" value="{{ $currency->id }}" <?php if($currency->status == 1) echo "checked";?> />
                                <span></span>
                            </label>
                        </td>
                        <td class="text-right">
