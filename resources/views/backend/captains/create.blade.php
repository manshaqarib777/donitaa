...
@section('content')
    ...
    <div class="mx-auto col-lg-12">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('admin.captains.store') }}" id="kt_form_1" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label>{{ translate('Captain Name') }}:</label>
                        <input type="text" id="name" class="form-control" placeholder="{{ translate('Captain Name') }}"
                            name="Captain[name]">
                    </div>
                    <div class="form-group">
                        <label>{{ translate('Email') }}:</label>
                        <input id="email-field" type="email" class="form-control" placeholder="{{ translate('Email') }}"
                            name="Captain[email]">
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="owner_name"
                                    placeholder="{{ translate('Owner Name') }}" name="Captain[responsible_name]">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="{{ translate('Owner Phone') }}"
                                    name="Captain[responsible_mobile]">
                            </div>
                        </div>
                    </div>
