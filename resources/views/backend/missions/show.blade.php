                            ...
                            @else
                                <div class="d-flex flex-column flex-root">
                                    ...
                                    <span class="opacity-70 d-block">
                                        ...
                                        @endphp
                                        <p style="margin-bottom: 0px;"><b>{{translate('Address')}} <small>{{ translate('One') }}</small>: </b>{{@$client_address->name}}</p>
                                        <p style="margin-bottom: 0px;"><b>{{translate('Address')}} <small>{{ translate('Two') }}</small>: </b>{{@$client_address->address}}</p>
                                    ...
                                    <span class="opacity-70 d-block">
                                        ...
                                        @endphp
                                        <p style="margin-bottom: 0px;"><b>{{translate('Address')}} <small>{{ translate('One') }}</small>: </b>{{@$receiver_address->name}}</p>
                                        <p style="margin-bottom: 0px;"><b>{{translate('Address')}} <small>{{ translate('Two') }}</small>: </b>{{@$receiver_address->address}}</p>                                        <p style="margin-bottom: 0px;"><b>{{translate('Country')}}: </b>{{@$mission->shipmentMissionID->shipment->to_country->name}}</p>
                                        <p style="margin-bottom: 0px;"><b>{{translate('Region')}}: </b>{{@$mission->shipmentMissionID->shipment->to_state->name}}</p>
                                        <p style="margin-bottom: 0px;"><b>{{translate('Area')}}: </b>{{@$mission->shipmentMissionID->shipment->to_area->name}}</p>
