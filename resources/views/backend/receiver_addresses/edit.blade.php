...
@section('content')
    ...
    <div class="col-lg-12 mx-auto">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('admin.receiver-addresses.update', ['receiver_address' => $receiver_address->id]) }}"
                            ...
                            <select id="change-receiver" name="ReceiverAddress[receiver_id]" class="form-control select-receiver">
                                ...
                                @foreach ($receivers as $receiver)
                                    <option value="{{ $receiver->id }}"
                                        {{ $receiver_address->receiver_id== $receiver->id ? 'selected' : '' }}>
