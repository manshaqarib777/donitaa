...
class PublicSslCommerzPaymentController extends Controller
{
    ...
    public function index($shipment)
    {
            ...
            //     if(Session::get('payment_type') == 'cart_payment'){
                    $post_data = array();
                    $post_data['total_amount'] = convert_price($shipment->tax + $shipment->shipping_cost + $shipment->insurance); # You cant not pay less than 10
                    $post_data['currency'] = \App\Currency::findOrFail(get_setting('system_default_currency'))->code;
                    ...
                    $post_data['value_c'] = $shipment->pay->type;
